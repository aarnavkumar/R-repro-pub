...
```{r fig3-heartrate, results = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Mean heart rate of stress and control groups at baseline and during intervention."}
